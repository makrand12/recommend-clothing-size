...
X_train['length'].dropna(inplace = True)
X_train['quality'].dropna(inplace =True)

X_test['height'].dropna(inplace = True)
X_test['length'].dropna(inplace = True)
X_test['quality'].dropna(inplace =True)
